    ...
    xhr.onreadystatechange = function(){
        if(this.readyState == 4 && this.status == 200){
            ...
            for (var i = 0; i < responseJson.items.length; i++){
                ...
                var videoThumbnail = responseJson.items[i].snippet.thumbnalis.medium.url;
                htmlContent += '<div class="video" onclick="showVideo(\''+videoId+'\')">'
                  htmlContent += '<img src="' + videoThmbnail + '">'
...
function showVideo(videoId){
    videoFrame.src = "http://www.youtube.com/embeed/" + videoId + "?autoplay=1";
    setTimeout(function(){
